    ...
    <div class="outerbox">
        ...
        <form name="frmSave" id="frmSave" method="post"  action="">
            ...
            <div class="centerCol">
                ...
                <select class="formSelect"  id="cmbProcessType" name="cmbProcessType"  <?php echo $disabled ?>><span class="required">*</span>
            ...
            <div class="leftCol" style="padding-top: 4px">  <input class="button" type="button"  onclick="returnLocDet1()" value="..." id="divisionPopBtn" <?php echo $disabled; ?> />
                <label for="txtLocation" style="width: 2px;">
                    <input type="hidden" value="<?php echo $disctrictId; ?>" class="formInputText" name="txtNWorkStaion" id="txtNWorkStaion" />    
                </label>
            </div><br class="clear">
...
function cleardata(){
    ...
    function returnLocDet1(){
        ...
        var popup=window.open('<?php echo public_path('../../symfony/web/index.php/admin/listCompanyStructure?mode=select_subunit&method=mymethod'); ?>&hiecodelevel='+limithie,'Locations','height=450 ,width=400 ,resizable=1,scrollbars=1');
...
//               cmbDivisionList: "<?php echo __("This field is required") ?>"
        ...
        $("#editBtn").click(function() {
            ...
            if (editMode == 1) {
                ...
                }else if($('#txtNWorkStaion').val() == ""){
                    alert("<?php echo __('Please select Work Station.') ?>");   
                }
                else 
